...
public class ModificarUsuari extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modificar_usuari);

        dni= (EditText)findViewById(R.id.dni2Text);
        ...
        modifica= (Button)findViewById(R.id.botoModificar);
